<?php
	define("HTTPS_ADDRESS", "http://xn--80aa3adxha4f.xn----ptbkgfnb1a.xn--p1ai/"); //HTTPS-Адрес, к которому будут обращаться скрипты. Со слэшем на конце.
	define("HTTP_ADDRESS", "http://xn--80aa3adxha4f.xn----ptbkgfnb1a.xn--p1ai/"); //HTTP-Адрес, к которому будут обращаться скрипты. Со слэшем на конце.
