...
class smssendingruAPI{
	...
	function getSenders(){
		return file_get_contents('http://lcab.sms-sending.ru/lcabApi/info.php?login='.HTTPS_LOGIN.'&password='.HTTPS_PASSWORD);
	}
	...
	function __construct($login, $paswd){
		require_once(dirname(__FILE__)."/config.php");
		define("HTTPS_LOGIN", $login);
		define("HTTPS_PASSWORD", $paswd);
