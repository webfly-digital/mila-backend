...
class UriTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function uriComponentsEncodingProvider()
    {
        ...
        return [
            ...
            ['/ˆ?ˆ#ˆ', '/%E2%82%AC', '%E2%82%AC', '%E2%82%AC', '/%E2%82%AC?%E2%82%AC#%E2%82%AC'],
    ...
    {
        $uri = (new Uri())->withPath('/baz?#ˆ/b%61r');
    ...
    {
        $uri = (new Uri())->withFragment('#ˆ?/b%61r');
