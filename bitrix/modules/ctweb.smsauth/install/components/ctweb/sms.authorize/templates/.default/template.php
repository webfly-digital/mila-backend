            ...
            <div class="col-md-8">
                <form action="<?= POST_FORM_ACTION_URI ?>" method="POST">
                    ...
                    <? if ($arResult['STEP'] === Manager::STEP_PHONE_WAITING) : ?>
	                    ...
	                    <div class="form-group">
                            ...
                            <input type="text" name="PHONE" placeholder=""
                                   value="<?= $arResult['USER_VALUES']['PHONE'] ?>" class="form-control"
                        ...
                        <input id="<?= $jsParams['TEMPLATE']['SUBMIT'] ?>" type="submit" value="<?= GetMessage("SMS_AUTH_GET_CODE") ?>" class="btn btn-primary">
                    <? elseif ($arResult['STEP'] === Manager::STEP_USER_WAITING): ?>
	                    <input id="<?= $jsParams['TEMPLATE']['STATE']  ?>" type="hidden" name="" value="USER_WAITING">
	                    <label for="smsauth-phone"><?= GetMessage("SMS_AUTH_SELECT_USER") ?></label>
                    ...
                    <? elseif ($arResult['STEP'] === Manager::STEP_CODE_WAITING): ?>
                        ...
                        <input id="<?= $jsParams['TEMPLATE']['SUBMIT'] ?>" type="submit" value="<?= GetMessage("SMS_AUTH_LOG_IN") ?>" class="btn btn-primary">
