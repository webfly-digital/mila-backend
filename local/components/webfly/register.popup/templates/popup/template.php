...
<div class="popup side" data-popup="auth_next" data-noscroll>
    ...
    <div class="user_login">
        ...
        <form method="post" action="" id="ctweb_smsauth_form_code">
            <label class="label">
                <p class="notify">Номер телефона</p>
...
<?php
// Подключаем скрипт модуля (если требуется вручную):
